  ...
  return (
    <div className="fixed w-full h-20 shadow-xl z-[100] px-3">
      ...
      <div className={ nav ? "md:hidden fixed left-0 top-0 w-full h-screen bg-black/70" : "" }>
        <div className={ nav 
                            ? "md:hidden fixed left-0 top-0 w-[75%] sm:w-[45%] md:w-[45%] h-screen bg-[#ecf0f3] p-10 ease-in duration-500"
          ...
          <div className="py-4 flex flex-col">
            ...
            <div className="pt-40">
              ...
              <div className="flex items-center justify-around my-4 w-full sm:w-[80%]">
                ...
                <div className="rounded-full shadow-lg shadow-gray-400 p-3 ml-2 cursor-pointer hover:scale-105 ease-in duration-500">
                  <FaGithub />
                </div>
                <div className="rounded-full shadow-lg shadow-gray-400 p-3 ml-2 cursor-pointer hover:scale-105 ease-in duration-500">
                  <AiOutlineMail />
